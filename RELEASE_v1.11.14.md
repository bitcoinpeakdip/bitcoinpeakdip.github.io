...
- product.html
- learn/index.html
- learn/ews-basics.html
- learn/strategy-guide.html
- learn/multi-tf-analysis.html
- learn/risk-management.html
- js/signals.js
- js/main.js
- js/learn.js
- version.json
...
## Next Steps:
1. Commit changes: `git add . && git commit -m "Release v1.11.14"`
